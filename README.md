...
| 3 | src/app/[locale]/auth/login/page.tsx  | Yo | Heuristica de visibilidad y contraste | Cuando se va a llenar el formulario no existe un contraste de lo que se está escribiendo en el formulario por lo tanto para personas con poca visibilidad y hasta personas con una visibilidad adecuada, casi no se puede leer. | Ponerle un color al texto de contraste al form. |
